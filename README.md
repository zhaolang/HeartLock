...
| [部署规范](./docs/backend/Deployment.md) | 部署方案和 CI/CD |
| [UI 规范](./docs/frontend/UISpec.md) | 视觉规范和页面设计 |
| [交互规范](./docs/frontend/Interaction.md) | 动效和手势操作 |
| [测试用例](./docs/testing/TestCases.md) | E2E 测试和性能测试 |
| [AI 开发指南](./docs/ai/DevelopmentGuide.md) | 开发环境和 AI 协作规范 |
